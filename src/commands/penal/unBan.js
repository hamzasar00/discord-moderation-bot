...
module.exports = {
    ...
    async execute(client, message, args, Embed) {
        ...
        await message.guild.members.unban(bannedUser.user.id, `${message.author.tag} tarafından yasağın kaldırılması istendi!`);
        ...
        if(log && client.channels.cache.get(log)) client.channels.cache.get(log).send(Embed.setColor('#00FF00').setFooter('').setImage(unbanGifs.random()).setDescription(`
