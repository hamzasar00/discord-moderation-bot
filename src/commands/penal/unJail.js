...
module.exports = {
    ...
    async execute(client, message, args, Embed) {
        ...
        if(!penal) return message.channel.error(message, `Bu üye için aktif bir jail ceza kaydı bulunamadı.`, { timeout: 8000, react: true });
        await user.roles.set(unregisterRoles);
